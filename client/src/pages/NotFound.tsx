...
export default function NotFound() {
  ...
  return (
    <Layout>
      ...
      <section className="container max-w-2xl mx-auto px-4 py-24">
        <div className="text-center mb-12">
          <div className="w-20 h-20 rounded-full bg-[var(--gold)]/15 flex items-center justify-center mx-auto mb-6">
            <span className="font-heading text-3xl font-black text-[var(--gold)]">404</span>
          </div>
          <h1 className="font-heading text-4xl font-black text-[var(--charcoal)] mb-4">
            This Page Doesn't Exist
          </h1>
          <p className="text-lg text-[var(--charcoal)]/60 leading-relaxed max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-[var(--charcoal)]/8 p-8 mb-8">
          <div className="flex items-center gap-2 mb-6">
            <BookOpen className="w-5 h-5 text-[var(--gold)]" />
            <h2 className="font-heading text-lg font-bold text-[var(--charcoal)]">
          ...
          <div className="space-y-4">
            {featured.slice(0, 6).map((article) => (
              ...
              >
                <div className="flex items-start gap-4 p-3 -mx-3 rounded-xl hover:bg-[var(--cream)] transition-colors">
                  ...
                  <div>
                    ...
                    <h3 className="font-heading text-base font-bold text-[var(--charcoal)] group-hover:text-[var(--gold)] transition-colors mt-0.5">
                      {article.title}
                    </h3>
                    <p className="text-sm text-[var(--charcoal)]/50 mt-1 line-clamp-1">
