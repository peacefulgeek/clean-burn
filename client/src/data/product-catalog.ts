...
export const PRODUCT_CATALOG: CatalogProduct[] = [
  ...
  { name: "Breaking the Cycle", asin: "1723297178", category: "Books", tags: ["addiction", "recovery", "cycle", "compulsive", "behavior", "relapse"], sentence: "For those looking for a simple solution, {{link}} by George Collins offers a clear recovery framework (paid link).", price_tier: "budget" },
  ...
  // JOURNALS & WORKBOOKS
  // ═══════════════════════════════════════════
  { name: "The Five Minute Journal", asin: "B0DPGKXGJ5", category: "Journals", tags: ["journal", "gratitude", "morning", "routine", "reflection", "mindfulness"], sentence: "One tool that fits naturally into a morning routine is {{link}}, a structured gratitude journal that takes about five minutes (paid link).", price_tier: "mid" },
  ...
  { name: "Addiction Recovery Journal", asin: "B09M74L6HB", category: "Journals", tags: ["addiction", "recovery", "journal", "tracking", "progress", "sobriety"], sentence: "A practical option for tracking recovery progress is {{link}}, designed specifically for daily check-ins (paid link).", price_tier: "budget" },
  ...
  // ═══════════════════════════════════════════
  { name: "Magnesium Glycinate 400mg", asin: "B000BD0RT0", category: "Supplements", tags: ["magnesium", "sleep", "anxiety", "calm", "supplement", "nervous system", "mineral"], sentence: "One supplement that many people in recovery find helpful for sleep is {{link}}, a highly absorbable form of magnesium (paid link).", price_tier: "budget" },
  ...
  { name: "Ashwagandha KSM-66", asin: "B0BZG1PXJK", category: "Supplements", tags: ["ashwagandha", "stress", "cortisol", "adaptogen", "supplement", "anxiety"], sentence: "For managing chronic stress, {{link}} is an adaptogen with solid research behind it (paid link).", price_tier: "budget" },
  ...
  { name: "B-Complex Vitamins", asin: "B005D0DTS2", category: "Supplements", tags: ["b vitamins", "energy", "mood", "nervous system", "supplement", "stress"], sentence: "A solid B-complex like {{link}} supports nervous system function and energy production during recovery (paid link).", price_tier: "budget" },
  { name: "Melatonin 1mg Low Dose", asin: "B00C3Q5JVE", category: "Supplements", tags: ["melatonin", "sleep", "circadian", "insomnia", "supplement", "rest"], sentence: "For resetting sleep patterns, a low-dose option like {{link}} can help without the grogginess of higher doses (paid link).", price_tier: "budget" },
  ...
  // ═══════════════════════════════════════════
  { name: "Weighted Blanket 20lb", asin: "B0CRB2Y4H5", category: "Devices", tags: ["weighted blanket", "anxiety", "sleep", "deep pressure", "calm", "evening"], sentence: "One thing that genuinely changed my evenings is {{link}}, which uses deep pressure to calm the nervous system (paid link).", price_tier: "mid" },
  { name: "Blue Light Blocking Glasses", asin: "B07W781XWF", category: "Devices", tags: ["blue light", "glasses", "sleep", "screen", "melatonin", "circadian", "evening"], sentence: "A small investment that makes a real difference is {{link}}, which blocks the blue light that suppresses melatonin (paid link).", price_tier: "budget" },
  { name: "Cold Plunge Tub", asin: "B0DG3S2HTJ", category: "Devices", tags: ["cold plunge", "cold exposure", "ice bath", "dopamine", "recovery", "nervous system"], sentence: "For those ready to try cold exposure, {{link}} is a practical home option (paid link).", price_tier: "premium" },
  { name: "Meditation Cushion Zafu", asin: "B093HFSVW5", category: "Devices", tags: ["meditation", "cushion", "zafu", "sitting", "mindfulness", "practice"], sentence: "If you sit for meditation, {{link}} makes a real difference for comfort and posture (paid link).", price_tier: "mid" },
  { name: "Breathing Trainer", asin: "B0GQ3SF4CR", category: "Devices", tags: ["breathwork", "breathing", "trainer", "respiratory", "vagus nerve", "device"], sentence: "For structured breathwork practice, {{link}} adds resistance training to your breathing (paid link).", price_tier: "mid" },
  { name: "Yoga Mat Extra Thick", asin: "B0FRG5TM2T", category: "Devices", tags: ["yoga", "mat", "exercise", "stretching", "body", "movement"], sentence: "A good foundation for any body practice is {{link}}, thick enough for comfort on hard floors (paid link).", price_tier: "budget" },
  ...
  { name: "Acupressure Mat", asin: "B0GD8RBY65", category: "Devices", tags: ["acupressure", "pain", "relaxation", "nervous system", "mat", "stress relief"], sentence: "Something that helps with evening wind-down is {{link}}, which stimulates pressure points to promote relaxation (paid link).", price_tier: "budget" },
  { name: "White Noise Machine", asin: "B00E6D6LQY", category: "Devices", tags: ["white noise", "sleep", "sound", "insomnia", "environment", "rest"], sentence: "For better sleep environments, {{link}} masks disruptive sounds and creates a consistent backdrop for rest (paid link).", price_tier: "budget" },
  ...
  { name: "Blackout Curtains", asin: "B077RPXSF3", category: "Devices", tags: ["blackout", "curtains", "sleep", "dark", "bedroom", "environment"], sentence: "Better sleep starts with a darker room, and {{link}} make a noticeable difference in sleep quality (paid link).", price_tier: "budget" },
  ...
  { name: "Massage Gun", asin: "B08CKWVYMF", category: "Devices", tags: ["massage", "tension", "muscle", "recovery", "percussion", "body"], sentence: "For releasing physical tension that builds up during stressful days, {{link}} targets tight muscles directly (paid link).", price_tier: "mid" },
  { name: "Standing Desk Converter", asin: "B0784HWPN6", category: "Devices", tags: ["standing desk", "posture", "work", "energy", "movement", "office"], sentence: "Changing your physical position during the day helps with energy and focus, and {{link}} makes that easy (paid link).", price_tier: "mid" },
  ...
  { name: "Oura Ring Gen 3", asin: "B0CSRBWPKY", category: "Apps", tags: ["oura", "sleep tracking", "hrv", "recovery", "biometric", "ring"], sentence: "For tracking sleep and recovery metrics, {{link}} provides data that helps you see progress objectively (paid link).", price_tier: "premium" },
  ...
  { name: "Electrolyte Powder", asin: "B07TT8B1JJ", category: "Nutrition", tags: ["electrolyte", "hydration", "energy", "mineral", "recovery", "water"], sentence: "Staying properly hydrated affects everything from mood to energy, and {{link}} helps with mineral balance (paid link).", price_tier: "budget" },
  ...
  { name: "MCT Oil", asin: "B00XM0Y9SE", category: "Nutrition", tags: ["mct", "brain", "energy", "ketones", "focus", "fat"], sentence: "For sustained mental energy, {{link}} provides brain fuel without the blood sugar spike (paid link).", price_tier: "mid" },
  ...
  { name: "Ear Plugs for Sleep", asin: "B0051U7W32", category: "Self-Care", tags: ["ear plugs", "sleep", "noise", "rest", "quiet", "environment"], sentence: "If noise disrupts your sleep, {{link}} designed for sleeping are more comfortable than standard foam (paid link).", price_tier: "budget" },
  ...
  // ═══════════════════════════════════════════
  { name: "Tibetan Singing Bowl", asin: "B06XHN7VRG", category: "Mindfulness", tags: ["singing bowl", "meditation", "sound", "vibration", "ritual", "mindfulness"], sentence: "For adding a sound element to meditation, {{link}} creates vibrations that help settle the mind (paid link).", price_tier: "mid" },
  ...
  { name: "Meditation Timer (Physical)", asin: "B0CD1S3FQ5", category: "Mindfulness", tags: ["timer", "meditation", "practice", "bell", "mindfulness", "session"], sentence: "A dedicated {{link}} removes the need to check your phone during practice (paid link).", price_tier: "mid" },
  { name: "Incense Sticks Sandalwood", asin: "B004C20O8A", category: "Mindfulness", tags: ["incense", "sandalwood", "meditation", "ritual", "environment", "practice"], sentence: "Lighting {{link}} before a session creates a sensory cue that tells your brain it's time to settle (paid link).", price_tier: "budget" },
  { name: "Meditation Bench", asin: "B09CZ6Y4VC", category: "Mindfulness", tags: ["meditation", "bench", "kneeling", "posture", "practice", "sitting"], sentence: "If sitting cross-legged is uncomfortable, {{link}} supports a kneeling position that's easier on the knees (paid link).", price_tier: "mid" },
  { name: "Mindfulness Cards Deck", asin: "1452168369", category: "Mindfulness", tags: ["mindfulness", "cards", "prompts", "reflection", "practice", "daily"], sentence: "For daily mindfulness prompts, {{link}} offers a different reflection each day without needing an app (paid link).", price_tier: "budget" },

  // ═══════════════════════════════════════════
  // RELATIONSHIP & INTIMACY
  // ═══════════════════════════════════════════
  { name: "The Gottman Card Decks", asin: "B0CYKKYHVH", category: "Relationship", tags: ["gottman", "couples", "relationship", "conversation", "intimacy", "cards"], sentence: "For rebuilding connection with a partner, {{link}} provides structured conversation starters backed by research (paid link).", price_tier: "budget" },
  { name: "Couple's Journal", asin: "B09CC3RHG2", category: "Relationship", tags: ["couples", "journal", "relationship", "communication", "intimacy", "writing"], sentence: "A shared {{link}} gives both partners space to reflect and communicate without the pressure of face-to-face conversation (paid link).", price_tier: "budget" },
  ...
  { name: "Blue Light Screen Protector", asin: "B0CD1S3FQ5", category: "Sleep", tags: ["blue light", "screen", "filter", "computer", "evening", "melatonin"], sentence: "If you must use a computer in the evening, {{link}} reduces blue light exposure at the source (paid link).", price_tier: "budget" },
  ...
  { name: "Countdown Timer Cube", asin: "B08PB9W3GT", category: "Tracking", tags: ["timer", "focus", "pomodoro", "productivity", "distraction", "work"], sentence: "For focused work sessions without touching your phone, {{link}} lets you flip to start a timer (paid link).", price_tier: "budget" },
  { name: "Dry Erase Calendar Board", asin: "1452168369", category: "Tracking", tags: ["calendar", "planning", "visual", "accountability", "schedule", "routine"], sentence: "Planning your week visually with {{link}} creates structure that supports recovery routines (paid link).", price_tier: "budget" },
  { name: "Accountability Partner Notebook", asin: "B09M74L6HB", category: "Tracking", tags: ["accountability", "partner", "journal", "check-in", "support", "recovery"], sentence: "For structured check-ins with an accountability partner, {{link}} provides a shared framework (paid link).", price_tier: "budget" },
